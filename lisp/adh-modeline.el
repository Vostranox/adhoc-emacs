...
;; Maps each meow state to its (mode-line-label . face) pair.
...
;; Show the coding system plus an end-of-line glyph: ":" unix, "\" DOS, "/" Mac.
...
(defun adh--segment-modal-fn ()
  "Return the current meow state as a faced N/I/G label, or nil."
...
(defun adh--segment-tab ()
  "Return a tab list segment (current tab highlighted) when more than one tab exists."
