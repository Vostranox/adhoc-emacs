...
(keymap-set global-map "M-l" (=> (avy-goto-line) (back-to-indentation)))
(keymap-set global-map "M-d" #'kill-word)
(keymap-set global-map "M-c" #'avy-goto-char-timer)
...
(keymap-set global-map "M-s" #'isearch-forward-thing-at-point)
...
(keymap-set global-map "C-x C-o" #'dashboard-open)
...
(keymap-set adh-magit-keymap "h" #'adh-magit-switch-or-status)
...
(keymap-set adh-buffer-keymap "a" #'persp-ibuffer)
...
(keymap-set adh-persp-keymap "x" (=> (persp-forget-buffer (buffer-name)) (delete-window)))
(keymap-set adh-persp-keymap "w" #'persp-merge)
(keymap-set adh-persp-keymap "m" #'persp-unmerge)
