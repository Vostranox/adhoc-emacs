...
(define-derived-mode my-glsl-ts-mode c++-ts-mode "my-glsl-ts-mode")
(add-to-list 'auto-mode-alist '("\\.glsl\\'" . my-glsl-ts-mode))
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs '(my-glsl-ts-mode . ("glsl_analyzer"))))
